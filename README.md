...
4. Enable Plugins
5. Use SteamGameInstance as your Game Instance (Project Settings - Maps And Modes)
6. Add SteamSeshComp to your gameplay controller (Example: BP_FirstPersonController)
7. On Begin Play, Inside the controller, set controller ref for the component and initialize the component.

In the image you can see steps 6 and 7
